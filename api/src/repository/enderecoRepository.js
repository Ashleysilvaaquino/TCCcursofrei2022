...
export async function salvarEndereco(idContaUsuario, endereco) {
  ...
  const [info] = await con.query(comando, [idContaUsuario, endereco.referencia, endereco.cep, endereco.residencia, endereco.estado, endereco.cidade, endereco.logradouro, endereco.complemento, endereco.bairro]);
